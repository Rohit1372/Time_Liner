...
import com.example.timeliner.databinding.BottomSheetLayoutBinding
import com.example.timeliner.databinding.FragmentSaveOrDeleteBinding
...
class SaveOrDeleteFragment : Fragment(R.layout.fragment_save_or_delete) {
    ...
    private fun setUpNote() {
        ...
        if(note==null)
        {
            contentBinding.lastEdited.text = getString(R.string.edited_on,
